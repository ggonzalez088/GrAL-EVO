...
func HandleIKESAINIT(
	...
	//XFRM sortzeko beharrezkoa da "ChildSecurityAssociation" motako SA bat erabiltzea, beraz, IKESA ren datuak kopiatzen dira

	// var IKESecurityAssociation = new (context.ChildSecurityAssociation)

	// if err = xfrm.ApplyXFRMRule(true, n3ueSelf.N3ueInfo.XfrmiId, IKESecurityAssociation); err != nil {
